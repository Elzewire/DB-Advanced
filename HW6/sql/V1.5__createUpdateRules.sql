...
AS ON UPDATE TO inherited_hub
    WHERE (NEW.id BETWEEN 1 and 100000) AND (OLD.id NOT BETWEEN 1 and 100000)
DO INSTEAD
    (DELETE FROM inherited_hub WHERE id = OLD.id and name = OLD.name;
    INSERT INTO inherited1 VALUES (NEW.id, NEW.name));

CREATE OR REPLACE RULE redirect_update_to_inherited2
AS ON UPDATE TO inherited_hub
    WHERE (NEW.id BETWEEN 100001 and 200000) AND (OLD.id NOT BETWEEN 100001 and 200000)
DO INSTEAD
    (DELETE FROM inherited_hub WHERE id = OLD.id and name = OLD.name;
...
AS ON UPDATE TO inherited_hub
    WHERE (NEW.id BETWEEN 200001 and 300000) AND (OLD.id NOT BETWEEN 200001 and 300000)
DO INSTEAD
    (DELETE FROM inherited_hub WHERE id = OLD.id and name = OLD.name;
...
AS ON UPDATE TO inherited_hub
    WHERE (NEW.id BETWEEN 300001 and 400000) AND (OLD.id NOT BETWEEN 300001 and 400000)
DO INSTEAD
    (DELETE FROM inherited_hub WHERE id = OLD.id and name = OLD.name;
...
AS ON UPDATE TO inherited_hub
    WHERE (NEW.id BETWEEN 400001 and 500000) AND (OLD.id NOT BETWEEN 400001 and 500000)
DO INSTEAD
    (DELETE FROM inherited_hub WHERE id = OLD.id and name = OLD.name;
...
AS ON UPDATE TO inherited_hub
    WHERE (NEW.id BETWEEN 500001 and 600000) AND (OLD.id NOT BETWEEN 500001 and 600000)
DO INSTEAD
    (DELETE FROM inherited_hub WHERE id = OLD.id and name = OLD.name;
...
AS ON UPDATE TO inherited_hub
    WHERE (NEW.id BETWEEN 600001 and 700000) AND (OLD.id NOT BETWEEN 600001 and 700000)
DO INSTEAD
    (DELETE FROM inherited_hub WHERE id = OLD.id and name = OLD.name;
...
AS ON UPDATE TO inherited_hub
    WHERE (NEW.id BETWEEN 700001 and 800000) AND (OLD.id NOT BETWEEN 700001 and 800000)
DO INSTEAD
    (DELETE FROM inherited_hub WHERE id = OLD.id and name = OLD.name;
...
AS ON UPDATE TO inherited_hub
    WHERE (NEW.id BETWEEN 800001 and 900000) AND (OLD.id NOT BETWEEN 800001 and 900000)
DO INSTEAD
    (DELETE FROM inherited_hub WHERE id = OLD.id and name = OLD.name;
...
AS ON UPDATE TO inherited_hub
    WHERE (NEW.id BETWEEN 900001 and 1000000) AND (OLD.id NOT BETWEEN 900001 and 1000000)
DO INSTEAD
    (DELETE FROM inherited_hub WHERE id = OLD.id and name = OLD.name;
